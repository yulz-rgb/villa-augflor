 ...
 *
 * Distances & drive times are measured from 26 Chemin des Collines, 06800
 * Cagnes-sur-Mer (off-peak driving). Ratings are indicative Google
...
(function () {
  ...
  var ORIGIN = "26 Chemin des Collines, 06800 Cagnes-sur-Mer, France";
  ...
  var IMAGES = {
    ...
    "jet-ski": "assets/photos/area/jet-ski.jpg",
    ...
    "gorges-loup-canyon": "assets/photos/area/gorges-loup-canyon.jpg",
    "speed-park": "assets/photos/area/speed-park.jpg",
    "rose-estates": "assets/photos/area/rose-estates.jpg",
    "organic-wine": "assets/photos/area/organic-wine.jpg",
    "sailing-school": "assets/photos/area/sailing-school.jpg"
  };
  ...
  var PLACES = [
    ...
    { id: "antibes", name: "Antibes & Juan-les-Pins", cat: "destinations", area: "11 km",
      ...
      rating: 4.6, reviews: 25000, km: 12, drive: 20, walk: null, cycle: 45,
    ...
    { id: "cannes", name: "Cannes & La Croisette", cat: "destinations", area: "23 km",
      ...
      rating: 4.5, reviews: 40000, km: 24, drive: 27, walk: null, cycle: null,
    ...
    { id: "monaco", name: "Monaco & Monte-Carlo", cat: "destinations", area: "32 km",
      ...
      rating: 4.6, reviews: 50000, km: 36, drive: 35, walk: null, cycle: null,
    ...
    { id: "eze-town", name: "Èze", cat: "destinations", area: "25 km",
      ...
      rating: 4.6, reviews: 18000, km: 33, drive: 31, walk: null, cycle: null,
    ...
    { id: "menton", name: "Menton", cat: "destinations", area: "45 km",
      ...
      rating: 4.6, reviews: 12000, km: 45, drive: 42, walk: null, cycle: null,
    ...
    { id: "grasse", name: "Grasse", cat: "destinations", area: "28 km",
      ...
      rating: 4.4, reviews: 10000, km: 23, drive: 35, walk: null, cycle: null,
    ...
    { id: "saint-tropez", name: "Saint-Tropez", cat: "destinations", area: "95 km",
      ...
      rating: 4.5, reviews: 22000, km: 101, drive: 90, walk: null, cycle: null,
    ...
    { id: "st-paul-de-vence", name: "Saint-Paul-de-Vence", cat: "villages", area: "10 km",
      ...
      rating: 4.6, reviews: 30000, km: 6, drive: 11, walk: null, cycle: 35,
    ...
    { id: "mougins", name: "Mougins", cat: "villages", area: "18 km",
      ...
      rating: 4.5, reviews: 4000, km: 21, drive: 21, walk: null, cycle: null,
    ...
    { id: "biot", name: "Biot", cat: "villages", area: "8 km",
      ...
      rating: 4.4, reviews: 5000, km: 11, drive: 17, walk: null, cycle: 25,
    ...
    { id: "tourrettes-sur-loup", name: "Tourrettes-sur-Loup", cat: "villages", area: "20 km",
      ...
      rating: 4.6, reviews: 2500, km: 19, drive: 58, walk: null, cycle: null,
    ...
    { id: "coaraze", name: "Coaraze", cat: "villages", area: "40 km",
      ...
      rating: 4.6, reviews: 900, km: 42, drive: 45, walk: null, cycle: null,
    ...
    { id: "la-garoupe", name: "Plage de la Garoupe", cat: "beaches", area: "14 km",
      ...
      rating: 4.5, reviews: 4000, km: 15, drive: 24, walk: null, cycle: null,
    ...
    { id: "plage-passable", name: "Plage de Passable", cat: "beaches", area: "22 km",
      ...
      rating: 4.4, reviews: 1800, km: 23, drive: 33, walk: null, cycle: null,
    ...
    { id: "paloma", name: "Paloma Beach", cat: "beaches", area: "25 km",
      ...
      rating: 4.4, reviews: 1500, km: 24, drive: 35, walk: null, cycle: null,
    ...
    { id: "plage-mala", name: "Plage Mala", cat: "beaches", area: "30 km",
      ...
      rating: 4.6, reviews: 3500, km: 34, drive: 35, walk: null, cycle: null,
    ...
    { id: "juan-les-pins", name: "Juan-les-Pins Beaches", cat: "beaches", area: "13 km",
      ...
      rating: 4.3, reviews: 6000, km: 12, drive: 19, walk: null, cycle: null,
    ...
    { id: "larvotto", name: "Larvotto Beach, Monaco", cat: "beaches", area: "32 km",
      ...
      rating: 4.3, reviews: 5000, km: 37, drive: 37, walk: null, cycle: null,
    ...
    { id: "aquasplash", name: "Aquasplash Antibes", cat: "family", area: "9 km",
      ...
      why: "The region's top water-park day for kids — twelve minutes away and open through the summer season.",
      rating: 4.1, reviews: 4000, km: 7, drive: 12, walk: null, cycle: null,
    ...
    { id: "parc-phoenix", name: "Parc Phoenix, Nice", cat: "family", area: "12 km",
      ...
      rating: 4.4, reviews: 9000, km: 8, drive: 10, walk: null, cycle: null,
    ...
    { id: "marineland-note", name: "Marineland (closed 2025)", cat: "family", area: "9 km",
      ...
      rating: null, reviews: null, km: 7, drive: 12, walk: null, cycle: null,
    ...
    { id: "azur-park", name: "Azur Park, Villeneuve-Loubet", cat: "family", area: "4 km",
      ...
      why: "Four minutes away and open into the evening — an easy crowd-pleaser when the kids need a treat.",
      rating: 4.2, reviews: 2500, km: 20, drive: 25, walk: null, cycle: 15,
    ...
    { id: "gorges-loup-canyon", name: "Canyoning, Gorges du Loup", cat: "family", area: "30 km",
      ...
      rating: 4.7, reviews: 1200, km: 21, drive: 26, walk: null, cycle: null,
    ...
    { id: "train-pignes", name: "Train des Pignes", cat: "family", area: "13 km",
      ...
      rating: 4.6, reviews: 2000, km: 93, drive: 93, walk: null, cycle: null,
    ...
    { id: "boat-charter", name: "Private Boat & Yacht Charter", cat: "watersports", area: "Antibes 11 km",
      ...
      rating: 4.8, reviews: 800, km: 11, drive: 19, walk: null, cycle: null,
    ...
    { id: "diving", name: "Scuba Diving & Snorkelling", cat: "watersports", area: "Antibes 13 km",
      ...
      rating: 4.7, reviews: 700, km: 12, drive: 19, walk: null, cycle: null,
    ...
    { id: "sailing-school", name: "Sailing & Catamaran Trips", cat: "watersports", area: "Antibes 11 km",
      ...
      rating: 4.7, reviews: 500, km: 11, drive: 19, walk: null, cycle: null,
    ...
    { id: "fondation-maeght", name: "Fondation Maeght", cat: "museums", area: "10 km",
      ...
      rating: 4.6, reviews: 3400, km: 6, drive: 12, walk: null, cycle: null,
    ...
    { id: "musee-matisse", name: "Musée Matisse, Nice", cat: "museums", area: "15 km",
      ...
      rating: 4.4, reviews: 7000, km: 15, drive: 19, walk: null, cycle: null,
    ...
    { id: "villa-ephrussi", name: "Villa Ephrussi de Rothschild", cat: "museums", area: "24 km",
      ...
      rating: 4.6, reviews: 12000, km: 22, drive: 33, walk: null, cycle: null,
    ...
    { id: "mamac", name: "MAMAC, Nice", cat: "museums", area: "14 km",
      ...
      rating: 4.4, reviews: 6000, km: 15, drive: 20, walk: null, cycle: null,
    ...
    { id: "chateau-bellet", name: "Château de Bellet", cat: "wine", area: "13 km",
      ...
      rating: 4.5, reviews: 200, km: 19, drive: 23, walk: null, cycle: null,
    ...
    { id: "rose-estates", name: "Provence Rosé Estate Day", cat: "wine", area: "Varies",
      ...
      rating: 4.8, reviews: 300, km: 98, drive: 84, walk: null, cycle: null,
    ...
    { id: "organic-wine", name: "Organic Estate, Villars-sur-Var", cat: "wine", area: "35 km",
      ...
      rating: 4.6, reviews: 150, km: 45, drive: 55, walk: null, cycle: null,
    ...
    { id: "mirazur", name: "Mirazur, Menton (3★)", cat: "food", area: "45 km",
      ...
      rating: 4.7, reviews: 2000, km: 47, drive: 44, walk: null, cycle: null,
    ...
    { id: "louis-xv", name: "Le Louis XV – Alain Ducasse, Monaco (3★)", cat: "food", area: "32 km",
      ...
      rating: 4.7, reviews: 1500, km: 36, drive: 35, walk: null, cycle: null,
    ...
    { id: "fenocchio", name: "Fenocchio Gelato, Nice", cat: "food", area: "13 km",
      ...
      rating: 4.5, reviews: 9000, km: 14, drive: 19, walk: null, cycle: null,
    ...
    { id: "eze-sunset-dining", name: "Sunset Dining, Èze", cat: "food", area: "25 km",
      ...
      rating: 4.6, reviews: 1800, km: 33, drive: 32, walk: null, cycle: null,
    ...
    { id: "sentier-cap-antibes", name: "Sentier du Littoral, Cap d'Antibes", cat: "nature", area: "14 km",
      ...
      rating: 4.7, reviews: 5000, km: 15, drive: 27, walk: null, cycle: null,
    ...
    { id: "cap-ferrat-walk", name: "Cap-Ferrat Coastal Path", cat: "nature", area: "24 km",
      ...
      rating: 4.7, reviews: 3000, km: 24, drive: 37, walk: null, cycle: null,
    ...
    { id: "gorges-du-loup", name: "Gorges du Loup & Cascades", cat: "nature", area: "30 km",
      ...
      rating: 4.6, reviews: 2500, km: 21, drive: 26, walk: null, cycle: null,
      website: null, maps: "Gorges du Loup, France",
    ...
    { id: "esterel", name: "Massif de l'Estérel", cat: "nature", area: "45 km",
      ...
      rating: 4.7, reviews: 4000, km: 55, drive: 65, walk: null, cycle: null,
    ...
    { id: "mercantour", name: "Parc National du Mercantour", cat: "nature", area: "70 km",
      ...
      rating: 4.8, reviews: 3000, km: 91, drive: 93, walk: null, cycle: null,
    ...
    { id: "mont-boron", name: "Mont Boron & Cap de Nice", cat: "nature", area: "16 km",
      ...
      rating: 4.7, reviews: 2500, km: 17, drive: 22, walk: null, cycle: null,
    ...
    { id: "italy-trip", name: "Italy: Ventimiglia & Dolceacqua", cat: "daytrips", area: "50 km",
      ...
      rating: 4.5, reviews: 3000, km: 59, drive: 54, walk: null, cycle: null,
    ...
    { id: "lerins", name: "Îles de Lérins", cat: "daytrips", area: "Cannes 23 km",
      ...
      rating: 4.6, reviews: 6000, km: 25, drive: 29, walk: null, cycle: null,
    ...
    { id: "verdon", name: "Gorges du Verdon", cat: "daytrips", area: "120 km",
      ...
      rating: 4.8, reviews: 8000, km: 109, drive: 124, walk: null, cycle: null,
    ...
    { id: "porquerolles", name: "Porquerolles Island", cat: "daytrips", area: "150 km",
      ...
      rating: 4.7, reviews: 5000, km: 150, drive: 114, walk: null, cycle: null,
    ...
    { id: "antibes-market", name: "Marché Provençal, Antibes", cat: "shopping", area: "11 km",
      ...
      rating: 4.6, reviews: 8000, km: 12, drive: 20, walk: null, cycle: null,
    ...
    { id: "cannes-beach-clubs", name: "Cannes Beach Clubs & Croisette", cat: "nightlife", area: "23 km",
      ...
      rating: 4.3, reviews: 6000, km: 24, drive: 27, walk: null, cycle: null,
    ...
    { id: "juan-nightlife", name: "Juan-les-Pins After Dark", cat: "nightlife", area: "13 km",
      ...
      rating: 4.2, reviews: 4000, km: 13, drive: 21, walk: null, cycle: null,
  ...
  function buildPicture(id, alt, position, lazy) {
    var meta = getImageMeta(id) || {};
    var pos = escAttr(position || meta.position || "center center");
    var loading = lazy === false ? "eager" : "lazy";
    var webpSet = buildSrcset(id, "webp");
    var fallback = primaryImageSrc(id);
    var w = meta.width && meta.width >= 640 ? Math.min(meta.width, 800) : 800;
    var h = meta.height && meta.width ? Math.round(w * (meta.height / meta.width)) : 600;
    return '' +
      '<picture>' +
        ...
        '<img class="ag-media-img area-card__image" src="' + fallback + '" alt="' + escAttr(alt) + '" ' +
          'width="' + w + '" height="' + h + '" loading="' + loading + '" decoding="async" ' +
  ...
  function getImageQc(placeId) {
    var qc = (typeof window !== "undefined" && window.AREA_IMAGE_QC) || {};
    return qc[placeId] || null;
  }

  function resolveImageId(p) {
    var qc = getImageQc(p.id);
    if (qc) {
      if (qc.imageStatus === "remove") return null;
      if (qc.image) return qc.image;
    }
    /* Only intentional shared images — not food/activity mismatches */
    var ALIASES = {
  ...
  function buildMediaInner(p, c) {
    ...
    var alt = (qc && qc.imageAlt) || p.imageAlt || (meta && meta.alt) || (p.name + " near Villa Augflor, French Riviera");
    var position = (meta && meta.position) || "center center";
    var fallbackCatId = getFallbackId(p.cat);
    var credit = meta && meta.credit ? meta.credit : (qc && qc.imageSource ? qc.imageSource : "");
    var caption = qc && qc.caption ? qc.caption : "";

    if (imageId && (!qc || qc.imageStatus !== "remove")) {
      return {
        inner: buildPicture(imageId, alt, position, true) +
          '<span class="area-card__imageOverlay" aria-hidden="true"></span>' +
          (caption ? '<span class="ag-photo-caption">' + escAttr(caption) + '</span>' : "") +
